...
class AddVendorPage {
  ...
  async addVendor(testController, testVendor) {
    ...
    await testController.typeText('#uniforms-0000-000f', testVendor.menuItem[0].name);
    await testController.typeText('#uniforms-0000-000g', testVendor.menuItem[0].price);
    await testController.typeText('#uniforms-0000-000h', testVendor.menuItem[0].description);
    await testController.typeText('#uniforms-0000-000i', testVendor.menuItem[0].image);
    await testController.click('#uniforms-0000-0008');
    await testController.typeText('#uniforms-0000-000p', testVendor.menuItem[1].name);
    await testController.typeText('#uniforms-0000-000q', testVendor.menuItem[1].price);
    await testController.typeText('#uniforms-0000-000r', testVendor.menuItem[1].description);
    await testController.typeText('#uniforms-0000-000s', testVendor.menuItem[1].image);
